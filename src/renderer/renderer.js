...
async function loadItemsToDropdown() {
	console.log("!!!loadItemsToDropdown!!!");
...
if (itemSelectElement && quantityElement && totalPriceElement) {
	...
	console.warn(
		"⚠️ Элементы калькулятора не найдены в HTML. Расчет стоимости неактивен.",
	);
}

function calculateTotal() {
	const selectedOption =
		itemSelectElement.options[itemSelectElement.selectedIndex];
